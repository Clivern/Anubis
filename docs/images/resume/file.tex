...
\WorkEntry{Senior Software Engineer}{Sept 2025 - Present}{Recorded Future, Amsterdam, Netherlands}{\begin{itemize}
\item Extend data processing capabilities to provide rich reports on Malware through static and dynamic analysis.
\item Build tools and Infrastructure to run the company's diverse workloads.
\item Managing over 10PB of data, running millions of VMs a day and processing TBs of data every hour.
\item Build web services to help users effectively interact with Recorded Future Sandbox.
...
\item Build tools to analyze and visualize the company's data.
\end{itemize}}
\sepspace

\WorkEntry{Software Engineer}{May 2022 - Sept 2025}{Cisco, Amsterdam, Netherlands}{\begin{itemize}
...
\item Gin, FastAPI, Django, Phoenix Frameworks, LangChain, LangGraph, PostgreSQL, MySQL Databases.
